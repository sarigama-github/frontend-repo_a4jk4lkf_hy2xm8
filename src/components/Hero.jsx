...
export default function Hero() {
  return (
    <section className="relative min-h-[90vh] w-full bg-transparent overflow-hidden">
      <div className="absolute inset-0">
        <Spline scene="https://prod.spline.design/Geb1kGWmIba9zPiH/scene.splinecode" style={{ width: '100%', height: '100%' }} />
      </div>

      {/* Soft light wash for readability over the textured background */}
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 sm:px-8 pt-28 pb-16 flex flex-col lg:flex-row items-center gap-12">
        <div className="w-full lg:w-1/2">
          <div className="inline-flex items-center gap-2 mb-6">
            ...
            <span className="text-slate-700 tracking-widest text-xs uppercase">LaunchPro Latino</span>
          </div>
          ...
          <p className="text-slate-700 text-lg sm:text-xl max-w-2xl mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
            ...
            <a href="https://wa.me/" target="_blank" rel="noopener" className="inline-flex items-center gap-2 text-slate-800 hover:text-slate-900 transition-colors">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm text-slate-800">
        ...
        <div className="w-full lg:w-1/2 aspect-video rounded-3xl border border-black/10 bg-white/50 backdrop-blur-sm hidden lg:block" />
      </div>
    </section>
  )
}
