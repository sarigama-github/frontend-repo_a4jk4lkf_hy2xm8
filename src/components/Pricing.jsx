    ...
    <section className="bg-black text-white py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {plans.map((p, i) => (
            <div key={i} className={`rounded-2xl border bg-white/[0.03] p-6 flex flex-col ${p.featured ? 'border-[rgba(212,175,55,0.6)] shadow-[0_0_25px_rgba(212,175,55,0.2)]' : 'border-white/10'}`}>
              ...
              <div className="text-white/80 mb-6">{p.desc}</div>
